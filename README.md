...
```bash
curl -L https://github.com/Arelius-D/NeXdocMan/releases/download/v3.2/NeXdocMan.tar.gz -o NeXdocMan.tar.gz && \
...
```bash
wget https://github.com/Arelius-D/NeXdocMan/releases/download/v3.2/NeXdocMan.tar.gz && \
tar -xzvf NeXdocMan.tar.gz && cd NeXdocMan && \
sudo chmod +x nexdocman.sh && sudo ./nexdocman.sh -d && \
cd .. && rm -rf NeXdocMan NeXdocMan.tar.gz
```
